...
var as = ue((_Ng, ss) => {
	...
	function bi(e, r) {
		...
		if ("TERM_PROGRAM" in G) {
			const n = parseInt((G.TERM_PROGRAM_VERSION || "").split(".")[0], 10);
...
var cs = ue((_Lg, us) => {
	...
	function ls(e) {
		...
		const r = (e || "").split(".").map((t) => parseInt(t, 10));
	...
	qc.exports = {
		...
		dependencies: {
			...
			"@prisma/prisma-schema-wasm":
				"6.18.0-8.34b5a692b7bd79939a9a2c3ef97d816e749cda2f",
...
var Di = ue((_kh, Es) => {
	Es.exports = (e, r = 1, t) => {
		...
		if (r === 0) return e;
		const n = t.includeEmptyLines ? /^/gm : /^(?!\s*$)/gm;
...
`,
	...
	function Ss(e) {
		return e?.DOTENV_KEY && e.DOTENV_KEY.length > 0
			? e.DOTENV_KEY
	...
	function cp(e, r) {
		...
		const o = `DOTENV_VAULT_${i.toUpperCase()}`,
			s = e.parsed[o];
		if (!s) {
			const a = new Error(
	...
	function pp(e) {
		!!e?.debug && ot("Loading env from encrypted .env.vault");
	...
	function dp(e) {
		...
		if (e?.path)
			if (!Array.isArray(e.path)) i = [Ps(e.path)];
				...
				i = [];
				for (const l of e.path) i.push(Ps(l));
			}
		let o,
			s = {};
		for (const l of i)
			try {
				const u = B.parse(Fi.readFileSync(l, { encoding: t }));
				B.populate(s, u, e);
			} catch (u) {
	...
	function fp(e, r) {
		...
		n = n.subarray(12, -16);
		try {
			const s = ip.createDecipheriv("aes-256-gcm", t, i);
			return s.setAuthTag(o), `${s.update(n)}${s.final()}`;
		} catch (s) {
			const a = s instanceof RangeError,
...
typeof process < "u" &&
	...
	($o = process.stdout?.isTTY));
var qo = {
	enabled:
		!Lo && Fo == null && Mo !== "dumb" && ((oi != null && oi !== "0") || $o),
};
function F(e, r) {
	const t = new RegExp(`\\x1b\\[${r}m`, "g"),
		n = `\x1B[${e}m`,
		i = `\x1B[${r}m`;
	return (o) =>
		!qo.enabled || o == null
...
var zr = {
	...
	enabled(e) {
		const r = globalThis.DEBUG.split(",").map((i) =>
				i.replace(/[.+?^${}()|[\]\\]/g, "\\$&"),
			),
			t = r.some((i) =>
				i === "" || i[0] === "-"
...
function Bu(e) {
	const r = {
		...
		t = (...n) => {
			const { enabled: i, namespace: o, color: s, log: a } = r;
			if (
				(n.length !== 0 && Yr.push([o, ...n]),
				Yr.length > Vu && Yr.shift(),
				zr.enabled(o) || i)
			) {
				const l = n.map((c) => (typeof c === "string" ? c : Uu(c))),
					u = `+${Date.now() - jo}ms`;
				(jo = Date.now()),
	...
	return new Proxy(t, { get: (_n, i) => r[i], set: (_n, i, o) => (r[i] = o) });
}
var N = new Proxy(Bu, {
	get: (_e, r) => zr[r],
	set: (_e, r, t) => (zr[r] = t),
...
function ai() {
	const e = process.env.PRISMA_QUERY_ENGINE_LIBRARY;
...
function Qo(...e) {
	const r = typeof e[0] === "string" ? e[0] : void 0,
...
var Be = (e) =>
	...
	_ng = Ue(A(je)),
	_ig = pe(A((e) => typeof e === "boolean")),
	_og = pe(A((e) => typeof e === "symbol")),
	_sg = pe(A((e) => e == null)),
	_ag = pe(A((e) => e != null));
...
async function Yo() {
	const e = Ht.default.platform(),
		r = process.arch;
	if (e === "freebsd") {
		const s = await Yt("freebsd-version");
...
async function Zu() {
	...
	try {
		const r = await mi.default.readFile(e, { encoding: "utf-8" });
		return zu(r);
	} catch {
		return {
			targetDistro: void 0,
...
function Xu(e) {
	const r = /^OpenSSL\s(\d+\.\d+)\.\d+/.exec(e);
	if (r) {
		const t = `${r[1]}.x`;
		return zo(t);
	}
...
async function rc(e) {
	...
	const i = await Yt("openssl version -v");
	if (i) {
...
var zt = globalThis.window?.document !== void 0,
	_gg = globalThis.process?.versions?.node !== void 0,
	_hg = globalThis.process?.versions?.bun !== void 0,
	_yg = globalThis.Deno?.version?.deno !== void 0,
	_bg = globalThis.process?.versions?.electron !== void 0,
	_Eg = globalThis.navigator?.userAgent?.includes("jsdom") === !0,
	_wg =
...
var M = O(require("node:path")),
	_Jc = O(on()),
	_wh = N("prisma:engines");
function ms() {
	return M.default.join(__dirname, "../");
}
var _xh = "libquery-engine";
...
function Ri(e) {
	...
	const r = Si.default.statSync(e),
		t = r.mode | 64 | 8 | 1;
	if (r.mode === t) {
		fs(`Execution permissions of ${e} are fine`);
		return;
	}
	const n = t.toString(8).slice(-3);
...
var ys = O(hs(), 1);
function Ci(e) {
	const r = (0, ys.default)(e);
	if (r === 0) return e;
	const t = new RegExp(`^[ \\t]{${r}}`, "gm");
	return e.replace(t, "");
}
...
function Kc(e) {
	let r;
	if (e.length > 0) {
		const t = e.find((n) => n.fromEnvVar !== null);
		t
			? (r = `env("${t.fromEnvVar}")`)
...
function Hc(e) {
	const r = Object.keys(e).reduce((t, n) => Math.max(t, n.length), 0);
...
function Cs(e) {
	const r = e.ignoreProcessEnv ? {} : process.env,
		t = (n) =>
			n.match(/(.?\${(?:[a-zA-Z0-9_]+)?})/g)?.reduce((o, s) => {
				const a = /(.?)\${([a-zA-Z0-9_]+)?}/g.exec(s);
				if (!a) return o;
				let l = a[1],
					u,
					c;
				if (l === "\\") (c = a[0]), (u = c.replace("\\$", "$"));
					...
					(c = a[0].substring(l.length)),
						(u = Object.hasOwn(r, p) ? r[p] : e.parsed[p] || ""),
						(u = t(u));
				}
				return o.replace(c, u);
			}, n) ?? n;
	for (const n in e.parsed) {
		const i = Object.hasOwn(r, n) ? r[n] : e.parsed[n];
		e.parsed[n] = t(i);
	}
	for (const n in e.parsed) r[n] = e.parsed[n];
	return e;
}
...
function hp(e, r, t) {
	const n = e?.dotenvResult.parsed,
		i = !Ds(e?.path, r);
	if (n && r && i && un.default.existsSync(r)) {
		const o = qi.default.parse(un.default.readFileSync(r)),
			s = [];
		for (const a in o) n[a] === o[a] && s.push(a);
		if (s.length > 0) {
			const a = xr.default.relative(process.cwd(), e.path),
				l = xr.default.relative(process.cwd(), r);
			if (t === "error") {
				const u = `There is a conflict between env var${s.length > 1 ? "s" : ""} in ${Y(a)} and ${Y(l)}
...
`;
				...
				const u = `Conflict for env var${s.length > 1 ? "s" : ""} ${s.map((c) => W(c)).join(", ")} in ${Y(a)} and ${Y(l)}
...
function pn(e, r) {
	const t = {};
	for (const n of Object.keys(e)) t[n] = r(e[n], n);
	return t;
}
function ji(e, r) {
...
m.clampedTo = m.clamp = function (e, r) {
	...
	return (t = this.cmp(e)), t < 0 ? e : this.cmp(r) > 0 ? r : new i(this);
};
...
m.cubeRoot = m.cbrt = function () {
	var e,
		...
		u,
		p = this.constructor;
	if (!this.isFinite() || this.isZero()) return new p(this);
	for (
		w = !1,
			o = this.s * U(this.s * this, 1 / 3),
			!o || Math.abs(o) === 1 / 0
				? ((t = J(this.d)),
					(e = this.e),
					(o = (e - t.length + 1) % 3) &&
		...
		if (
			...
			(l = a.times(a).times(a)),
			(u = l.plus(this)),
			(n = L(u.plus(this).times(a), u.plus(l), s + 2, 1)),
			J(a.d).slice(0, s) === (t = J(n.d)).slice(0, s))
		)
			if (((t = t.slice(s - 3, s + 1)), t === "9999" || (!i && t === "4999"))) {
				if (!i && (y(a, e + 1, 0), a.times(a).times(a).eq(this))) {
					n = a;
					break;
				}
				(s += 4), (i = 1);
				...
				(!+t || (!+t.slice(1) && t.charAt(0) === "5")) &&
					(y(n, e + 1, 1), (r = !n.times(n).times(n).eq(this)));
				break;
			}
...
m.dividedToIntegerBy = m.divToInt = function (e) {
	...
	return y(L(this, new t(e), 0, 1, 1), t.precision, t.rounding);
};
	...
	return this.isFinite()
		? this.isZero()
			...
			: ((e = n.precision),
				...
				(n.precision = e + 7),
				(n.rounding = 1),
				L(this.sinh(), this.cosh(), (n.precision = e), (n.rounding = r)))
		: new n(this.s);
};
...
m.logarithm = m.log = function (e) {
	...
	if (((t = this.d), this.s < 0 || !t || !t[0] || this.eq(1)))
		return new c(t && !t[0] ? -1 / 0 : this.s !== 1 ? NaN : t ? 0 : 1 / 0);
	if (r)
		if (t.length > 1) o = !0;
		else {
...
m.minus = m.sub = function (e) {
	...
	if (
		...
		if (d[0]) e.s = -e.s;
		else if (u[0]) e = new h(this);
		else return new h(l === 3 ? -0 : 0);
		return w ? y(e, a, l) : e;
	}
	if (
		((t = X(e.e / E)), (c = X(this.e / E)), (u = u.slice()), (o = c - t), o)
	) {
		for (
			p = o < 0,
				p
...
m.modulo = m.mod = function (e) {
	...
	return (
		...
		!this.d || !e.s || (e.d && !e.d[0])
			? new n(NaN)
			: !e.d || (this.d && !this.d[0])
				? y(new n(this), n.precision, n.rounding)
				: ((w = !1),
					n.modulo === 9
						? ((r = L(this, e.abs(), 0, 3, 1)), (r.s *= e.s))
						: (r = L(this, e, 0, n.modulo, 1)),
					(r = r.times(e)),
					(w = !0),
					this.minus(r))
	);
...
m.plus = m.add = function (e) {
	...
	if (
		...
		return c[0] || (e = new d(this)), w ? y(e, a, l) : e;
	if (
		((o = X(this.e / E)), (n = X(e.e / E)), (u = u.slice()), (i = o - n), i)
	) {
		for (
			i < 0
				? ((t = u), (i = -i), (s = c.length))
...
m.precision = m.sd = function (e) {
	...
	return (
		this.d
			? ((r = Us(this.d)), e && this.e + 1 > r && (r = this.e + 1))
			: (r = NaN),
		r
	);
};
m.round = function () {
	...
	return y(new r(this), this.e + 1, r.rounding);
};
	...
	return (
		...
		(d =
			L(u, n, o, 1)
				.minus(this)
				.abs()
				.cmp(L(l, t, o, 1).minus(this).abs()) < 1
				? [u, n]
				: [l, t]),
		(g.precision = c),
		(w = !0),
...
m.toString = function () {
	var r = this.constructor,
		t = ve(this, this.e <= r.toExpNeg || this.e >= r.toExpPos);
	...
	function i(o) {
		...
		if (l === "string")
			return (
				...
				Bs.test(o) ? gn(this, o) : Tp(this, o)
			);
		if (l === "bigint")
			return (
				o < 0 ? ((o = -o), (this.s = -1)) : (this.s = 1), gn(this, o.toString())
			);
		throw Error(He + o);
	}
	if (
		...
		for (
			...
			Object.hasOwn(e, (t = n[r++])) || (e[t] = this[t]);
	return i.config(e), i;
}
function jp(e, r) {
...
var dd = (e) => e,
	...
	md = 0,
	v = {
		manual: vn.Prism?.manual,
		disableWorkerMessageHandler: vn.Prism?.disableWorkerMessageHandler,
		util: {
			encode: (e) => {
				if (e instanceof ge) {
					const r = e;
			...
			clone: function e(r, t) {
				...
				switch (((t = t || {}), o)) {
					case "Object":
						...
						(n = {}), (t[i] = n);
						for (const s in r) Object.hasOwn(r, s) && (n[s] = e(r[s], t));
						return n;
					case "Array":
						return (
							(i = v.util.objId(r)),
			...
			insertBefore: (e, r, t, n) => {
				...
				for (const a in i)
					if (Object.hasOwn(i, a)) {
						if (a === r)
							for (const l in t) Object.hasOwn(t, l) && (o[l] = t[l]);
						Object.hasOwn(t, a) || (o[a] = i[a]);
					}
				const s = n[e];
				return (
					(n[e] = o),
		...
		plugins: {},
		highlight: (e, r, t) => {
			const n = { code: e, grammar: r, language: t };
			return (
		...
		matchGrammar: (e, r, t, n, i, o, s) => {
			for (const g in t) {
				if (!Object.hasOwn(t, g) || !t[g]) continue;
				if (g === s) return;
				let I = t[g];
				...
				for (let T = 0; T < I.length; ++T) {
					...
					if (me && !S.pattern.global) {
						const j = S.pattern.toString().match(/[imuy]*$/)[0];
					...
					for (let j = n, te = i; j < r.length; te += r[j].length, ++j) {
						...
						const fr = new ge(g, b ? v.tokenize(p, b) : p, Kr, p, me);
						if (
							(K.push(fr),
							h && K.push(h),
...
v.languages.markup?.tag.addInlined("script", "javascript");
...
var Pn = class e {
	...
	mapLineAt(r, t) {
		if (
			...
			return this;
		const n = r - this.firstLineNumber,
			i = [...this.lines];
	...
	slice(r, t) {
		const n = this.lines.slice(r - 1, t).join(`
`);
		return new e(
			r,
			zs(n).split(`
...
function Ed(
	...
	const s = bd({ message: r, originalMethod: t, isPanic: n, callArguments: i });
	...
	if (u && c) {
		...
		const f = String(u.lastLineNumber).length;
		if (
			((s.contextLines = u
...
var Ar = class {
	...
	write(r) {
		return (
			typeof r === "string" ? (this.currentLine += r) : r.write(this), this
		);
	}
	...
	newLine() {
		...
		const r = this.afterNextNewLineCallback;
...
`);
	...
	indentedCurrentLine() {
		const r = this.currentLine.padStart(
...
var Pe = class {
	...
	write(r) {
		const t = r.getCurrentLineLength();
...
var Dr = class e extends ze {
	...
	getDeepSubSelectionValue(r) {
		...
		for (const n of r) {
			...
			const i = t.getSubSelectionValue(n);
			if (!i) return;
			t = i;
		}
		return t;
	...
	getDeepSelectionParent(r) {
		const t = this.getSelectionParent();
		if (!t) return;
		let n = t;
		for (const i of r) {
	...
	getSelectionParent() {
		...
		const t = this.getField("include")?.value.asObject();
	...
	getPrintWidth() {
		...
		return r.length === 0
			? 2
			: Math.max(...r.map((n) => n.getPrintWidth())) + 2;
	}
	write(r) {
...
function Ad(e, r) {
	const t = r.arguments.getDeepSubSelectionValue(e.selectionPath)?.asObject();
	t &&
...
function Id(e, r, t) {
	const n = r.arguments.getDeepSubSelectionValue(e.selectionPath)?.asObject();
	if (n) {
...
function Dd(e, r, t) {
	t.removeAllFields();
	for (const n of e.outputType.fields) t.addSuggestion(new le(n.name, "false"));
	r.addErrorMessage(
		(n) =>
...
function _d(e, r) {
	...
	r.addErrorMessage((n) => {
		const i = [`Unknown field ${n.red(`\`${t.fieldName}\``)}`];
		return (
...
function ua(e, r, t) {
	const n = [`Unknown argument \`${e.red(r)}\`.`],
		i = Jd(r, t);
	return (
...
function $d(e, r) {
	const t = e.argument.name,
		n = r.arguments.getDeepSubSelectionValue(e.selectionPath)?.asObject();
	n?.getDeepFieldValue(e.argumentPath)?.markAsError(),
		r.addErrorMessage((i) => {
			const o = In(
				"or",
...
function qd(e, r) {
	...
	n?.getDeepFieldValue(e.argumentPath)?.markAsError(),
		r.addErrorMessage((i) => {
			const o = [`Invalid value for argument \`${i.bold(t)}\``];
			if (
...
function ha(e) {
	...
	if (e instanceof Date) {
		const r = mn(e) ? e.toISOString() : "Invalid Date";
...
function Kd(e) {
	const r = new Ir();
	for (const t of e) r.addItem(ha(t));
	return r;
}
function _n(e, r) {
	const t = r === "pretty" ? aa : Cn,
...
function Nn({
	...
	const a = _r(e);
	for (const p of r) Sn(p, a, s);
	const { message: l, args: u } = _n(a, t),
		c = Tn({
			message: l,
			callsite: n,
			originalMethod: i,
...
function Ea(e, r) {
	...
	for (const n of Object.values(r))
		if (e[n.name]) for (const i of n.needs) t[i] = !0;
	return t;
}
function wa(e, r) {
	if (!r) return e;
	const t = { ...e };
	for (const n of Object.values(r))
		if (!e[n.name]) for (const i of n.needs) delete t[i];
	return t;
}
var Ln = class {
		constructor(r, t) {
		...
		batchCallbacks = lt(() => {
			const r = this.previous?.getAllBatchQueryCallbacks() ?? [],
		...
		getAllQueryCallbacks(r, t) {
			return this.queryCallbacksCache.getOrCreate(`${r}:${t}`, () => {
				const n = this.previous?.getAllQueryCallbacks(r, t) ?? [],
					i = [],
...
function em(e, r, t) {
	for (const [n, i] of Object.entries(r)) {
		if (Se(i)) continue;
		const o = t.nestSelection(n);
		if ((eo(i, o), i === !1 || i === void 0)) {
			e[n] = !1;
			continue;
		}
		const s = t.findField(n);
		if (
			(s &&
				s.kind !== "object" &&
...
function tm(e, r) {
	...
	for (const [o, s] of Object.entries(i)) {
		if (Se(s)) continue;
		const a = r.nestSelection(o);
		eo(s, a);
		const l = r.findField(o);
		if (!(n?.[o] && !l)) {
...
function Sa(e, r) {
	...
	if (ArrayBuffer.isView(e)) {
		const { buffer: t, byteOffset: n, byteLength: i } = e;
...
function nm(e, r) {
	...
	for (let n = 0; n < e.length; n++) {
		const i = r.nestArgument(String(n)),
			o = e[n];
		if (o === void 0 || Se(o)) {
...
var ie = class e {
	constructor(r, t) {
		...
		const n = t.reduce((s, a) => s + (a instanceof e ? a.values.length : 1), 0);
...
function he(e, r) {
	const t = am(r),
		...
		i = new Proxy(e, {
			...
			ownKeys(o) {
				const s = _a(Reflect.ownKeys(o), t),
...
function Un(e = {}) {
	return (r) => (
		typeof e._count === "boolean" && (r._count = r._count._all), r
	);
}
function Ma(e, r) {
	const t = Un(e);
...
function Rm(e = {}) {
	...
	if (Array.isArray(r.by))
		for (const t of r.by) typeof t === "string" && (r.select[t] = !0);
...
function ja(e, r) {
	const t = r.fields.filter((i) => !i.relationName),
		n = _s(t, "name");
	return new Proxy(
		{},
		{
...
function lo(e, r, t, n, i, o) {
	const a = e._runtimeDataModel.models[r].fields.reduce(
		(l, u) => ({ ...l, [u.name]: u }),
		{},
	);
	return (l) => {
		const u = Ze(e._errorFormat),
			c = Cm(n, i),
			p = Im(l, o, c),
...
function uo(e, r) {
	const t = e._extensions.getAllModelExtensions(r) ?? {},
		n = [
			_m(e, r),
			Lm(e, r),
			xt(t),
...
function Lm(e, r) {
	return lr(
		re("fields", () => {
			const t = e._runtimeDataModel.models[r];
			return ja(r, t);
		}),
	);
}
...
function Fm(e) {
	const r = Object.getPrototypeOf(e._originalClient),
...
function Mm(e) {
	const r = Object.keys(e._runtimeDataModel.models),
		t = r.map(Te),
...
function Wa(e) {
	...
	const r = Object.create(this._originalClient, {
...
function Ja({ result: e, modelName: r, select: t, omit: n, extensions: i }) {
	const o = i.getAllComputedFields(r);
	if (!o) return e;
	const s = [],
		a = [];
	for (const l of Object.values(o)) {
		if (n) {
			...
			const u = l.needs.filter((c) => n[c]);
			u.length > 0 && a.push(Fr(u));
		} else if (t) {
			if (!t[l.name]) continue;
			const u = l.needs.filter((c) => !t[c]);
			u.length > 0 && a.push(Fr(u));
		}
...
function Ka({
	...
	for (const [o, s] of Object.entries(e)) {
		...
		const l = n.models[t].fields.find((c) => c.name === o);
		if (!l || l.kind !== "object" || !l.relationName) continue;
		const u = typeof s === "object" ? s : {};
		r[o] = Gn({
			visitor: i,
			result: r[o],
			args: u,
...
function Xa(e, r, t, n = 0) {
	return e._createPrismaPromise((i) => {
		const o = r.customDataProxyFetch;
		return (
			"transaction" in r &&
				i !== void 0 &&
...
function el(e, r) {
	const { jsModelName: t, action: n, clientMethod: i } = r,
		o = t ? n : i;
	if (e._extensions.isEmpty()) return e._executeRequest(r);
	const s = e._extensions.getAllQueryCallbacks(t ?? "$none", o);
	return Xa(e, r, s);
}
function rl(e) {
	return (r) => {
...
function sl({ postinstall: e, ciName: r, clientVersion: t, generator: n }) {
	if (
		...
		const i = `Prisma has detected that this project was built on ${r}, which caches dependencies. This leads to an outdated Prisma Client because Prisma's auto-generation isn't triggered. To fix this, make sure to run the \`prisma generate\` command during the build process.
...
function Qn(e) {
	const { runtimeBinaryTarget: r } = e;
	return `Add "${r}" to \`binaryTargets\` in the "schema.prisma" file and run \`prisma generate\` after saving it:

${Um(e)}`;
}
function Um(e) {
	const { generator: r, generatorBinaryTargets: t, runtimeBinaryTarget: n } = e,
...
function cl(e) {
	const { runtimeBinaryTarget: r, generatorBinaryTargets: t } = e,
		n = t.find((i) => i.native);
	return `${Xe(e)}
...
async function ml(e, r) {
	...
	const { enginePath: n, searchedLocations: i } = await Wm(e, r);
	if (
...
function vl(e) {
	...
	process.env.TEST_CLIENT_ENGINE_REMOTE_EXECUTOR &&
		...
		(l = "http:");
	const u = new URL(i.href.replace(o, l));
...
var $ = class extends oe {
	...
	constructor(r, t) {
		...
		const n = this.response.headers.get("prisma-request-id");
		if (n) {
			const i = `(The request id was: ${n})`;
	...
	try {
		...
		if (typeof t === "object" && t !== null) {
			...
			if (
				...
				const n = Object.values(t)[0].reason;
...
async function Ft(e, r) {
	if (e.ok) return;
	const t = { clientVersion: r, response: e },
		n = await uf(e);
...
async function df(e, r) {
	const t = Al["@prisma/engines-version"],
...
var Dl = 3,
	...
	qt = class {
		...
		async start() {
			this.startPromise !== void 0 && (await this.startPromise),
				(this.startPromise = (async () => {
					const { apiKey: r, url: t } = this.getURLAndAPIKey();
					(this.host = t.host),
		...
		async uploadSchema() {
			const r = { name: "schemaUpload", internal: !0 };
			return this.tracingHelper.runInChildSpan(r, async () => {
				const t = await dr(await this.url("schema"), {
					method: "PUT",
				...
				const n = await Ft(t, this.clientVersion);
				if (n)
					throw (
...
var _l = {
	async loadLibrary(e) {
		...
		try {
			...
			const i = Ai({ e: n, platformInfo: r, id: t });
...
var xo,
	Nl = {
		async loadLibrary(e) {
			const { clientVersion: r, adapter: t, engineWasm: n } = e;
			if (t === void 0)
				throw new P(
...
var Qr = class {
	...
	constructor(r, t) {
		...
		const n = Object.keys(r.overrideDatasources)[0],
	...
	async transaction(r, t, n) {
		...
		if (xf(a)) {
			const l = this.getExternalAdapterError(a, i?.errorRegistry);
			throw l
				? l.error
				: new z(a.message, {
						code: a.error_code,
	...
	async getCurrentBinaryTarget() {
		{
			...
			const r = await this.tracingHelper.runInChildSpan("detect_platform", () =>
				ir(),
			);
			if (!Ll.includes(r))
				throw new P(
...
You may have to run ${qe("prisma generate")} for your changes to take effect.`,
	...
	async loadEngine() {
		if (!this.engine) {
			...
			try {
				...
				const t = await this.adapterPromise;
	...
	logger(r) {
		const t = this.parseEngineResponse(r);
		t &&
	...
	async start() {
		...
		const r = async () => {
			Re("library starting");
			try {
				const t = { traceparent: this.tracingHelper.getTraceParent() };
				...
				const n = this.parseInitError(t.message);
				throw typeof n === "string"
					? t
					: new P(n.message, this.config.clientVersion, n.error_code);
			} finally {
	...
	async request(r, { traceparent: t, interactiveTransaction: n }) {
		...
		const i = JSON.stringify({ traceparent: t }),
			o = JSON.stringify(r);
		try {
			await this.start();
...
${a.backtrace}`,
	...
	async requestBatch(r, { transaction: t, traceparent: n }) {
		...
		const { batchResult: l, errors: u } = a;
		if (Array.isArray(l))
			return l.map((c) =>
	...
	buildQueryError(r, t) {
		...
		const n = this.getExternalAdapterError(r.user_facing_error, t);
		return n
			? n.error
	...
	getExternalAdapterError(r, t) {
		if (r.error_code === hf && t) {
			...
			const i = t.consumeError(n);
			return ln(i, "External error with reported id was not registered"), i;
		}
	}
	async metrics(r) {
		await this.start();
		const t = await this.engine.metrics(JSON.stringify(r));
...
`);
	...
	const f = { accelerate: d, ppg: u, driverAdapters: c };
	function h(g) {
		return g.length > 0;
	}
	return h(o)
...
function Ml({ copyEngine: e = !0 }, r) {
	...
	for (const p of o.warnings) at(...p.value);
	if (!n) {
		const p = o.errors[0];
		throw new Z(p.value, { clientVersion: r.clientVersion });
	}
	const s = Er(r.generator),
		a = s === "library",
		_l = s === "binary",
		_u = s === "client",
		_c = (i.accelerate || i.ppg) && !i.driverAdapters;
	return i.accelerate
		? new qt(r)
...
function Gl(e) {
	...
	const r = {};
	for (const t of Object.keys(e)) r[t] = Bl(e[t]);
	return r;
}
function Bl(e) {
...
var Tf = xi.split(".")[0],
	...
	Ao = class {
		...
		getGlobalTracingHelper() {
			const r = globalThis[`V${Tf}_PRISMA_INSTRUMENTATION`],
...
function zl(e) {
	return typeof e === "string"
		...
		: e.reduce(
				(r, t) => {
					const n = typeof t === "string" ? t : t.level;
					return n === "query"
						? r
						: r && (t === "info" || r === "info")
							? "info"
...
var Zn = class {
	...
	tickActive = !1;
	request(r) {
		const t = this.options.batchBy(r);
		return t
			? (this.batches[t] ||
					((this.batches[t] = []),
					this.tickActive ||
	...
	ei = class {
			...
			(this.logEmitter = t),
				...
				(this.dataloader = new Zn({
					...
					singleLoader: async (n) => {
						const i =
								n.transaction?.kind === "itx" ? Xl(n.transaction) : void 0,
		...
		handleRequestError({
			...
			if (
				...
				const u = s ? { modelName: s, ...r.meta } : r.meta;
				throw new z(l, {
					code: r.code,
					clientVersion: this.client._clientVersion,
					meta: u,
	...
	kf = {
		datasources: (e, { datasourceNames: r }) => {
			if (e) {
				...
				for (const [t, n] of Object.entries(e)) {
					if (!r.includes(t)) {
						const i = Jr(t, r) || ` Available datasources: ${r.join(", ")}`;
						throw new _(
...
Expected string or undefined.`);
		...
		omit: (e, r) => {
			...
			for (const [n, i] of Object.entries(e)) {
				const o = Nf(n, r.runtimeDataModel);
				if (!o) {
					t.push({ kind: "UnknownModel", modelKey: n });
					continue;
				}
				for (const [s, a] of Object.entries(i)) {
					const l = o.fields.find((u) => u.name === s);
					if (!l) {
		...
		__internal: (e) => {
			if (!e) return;
			const r = ["debug", "engine", "configOverride"];
			if (typeof e !== "object")
				throw new _(
...
function _f(e, r) {
	...
	const t = r.map((i) => ({ value: i, distance: (0, su.default)(e, i) }));
...
function ou(e, r) {
	const t = Object.keys(e).find((n) => We(n) === r);
	if (t) return e[t];
}
function Lf(e, r) {
	const t = _r(e);
	...
	const { message: n, args: i } = _n(t, "colorless");
...
function fu(e) {
	class r {
		...
		constructor(n) {
			...
			const i = new du.EventEmitter().on("error", () => {});
		...
		_request(n) {
			...
			const i = n.middlewareArgsMapper ?? Ff,
				o = {
